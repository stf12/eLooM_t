 ...
 */
inline uint8_t ACGetTaskCount(ApplicationContext *_this);
 ...
 */
inline AManagedTask *ACGetFirstTask(ApplicationContext *_this);
 ...
 */
inline AManagedTask *ACGetNextTask(ApplicationContext *_this, const AManagedTask *pTask);
