 ...
 * @return \a SYS_NO_ERROR_CODE if success, a task specific error code otherwise.
 */
inline sys_error_code_t AMTOnEnterTaskControlLoop(AManagedTask *_this);
 ...
 */
inline EPowerMode AMTGetSystemPowerMode(void);
 ...
 */
inline EPowerMode AMTGetTaskPowerMode(AManagedTask *_this);
 ...
 */
inline sys_error_code_t AMTSetPMStateRemapFunc(AManagedTask *_this, EPowerMode *pPMState2PMStateMap);
