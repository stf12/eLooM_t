 ...
 * @sa ISourceGetId()
 */
inline uint8_t ISourceGetId(ISourceObservable *_this) {
 ...
 */
inline IEventSrc * ISourceGetEventSrcIF(ISourceObservable *_this) {
 ...
 * @sa ISourceGetODR()
 */
inline sys_error_code_t ISourceGetODR(ISourceObservable *_this, float *p_measured, float *p_nominal) {
 ...
 * @sa ISourceGetFS()
 */
inline float ISourceGetFS(ISourceObservable *_this) {
 ...
 */
inline float ISourceGetSensitivity(ISourceObservable *_this) {
